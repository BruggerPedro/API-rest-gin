...
func TestVerificaStatusCode(t *testing.T) {
	...
	mockDaResposta := `{"API diz:":"E aí pedro, tudo beleza?"}`
...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Nome Teste", CPF: "12345678909", RG: "12345678"}
...
func TestEditaAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Nome Teste", CPF: "47123456789", RG: "12345670"}
	...
	assert.Equal(t, "12345670", alunoMockAtualizado.RG)
